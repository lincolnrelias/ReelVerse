...
export async function extractVideo(
  ...
  const meta: VideoMeta = {
    ...
    viewCount: raw.viewCount ? Number(raw.viewCount) : videoData.viewCount ? Number(videoData.viewCount) : parseViewCount(add.view_count?.view_count?.text || add.view_count?.original_view_count),
